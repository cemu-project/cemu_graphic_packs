...
It's recommended to download all the graphic packs. Download [this archive](https://ci.appveyor.com/api/projects/slashiee/cemu-graphic-packs/artifacts/bin/graphicPacks.zip?branch=master) to get all of the graphic packs. Please delete the old ones first before adding in the new ones.
