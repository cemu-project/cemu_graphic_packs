...
0x025532E8 = nop
;"isFreeCamera__Q2_3cfs14CfSceneManagerCFv" in update__Q2_3cfs14CfSceneFreeCamFv
0x02601CFC = nop
;"MenuTask::openHudEventCamera" in dispFieldCamera__Q2_2ev16CUIManagerAlwaysFb
0x0276A774 = nop
