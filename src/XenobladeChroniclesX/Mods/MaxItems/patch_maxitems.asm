...
0x023624C0 = cmplwi r12, 999
0x0236293C = cmplwi r12, 999

0x02363210 = li r0, 999 ; when some items in stock
0x02363230 = li r0, 999 ; when no item in stock
...
0x0236234C = cmplwi r12, 999
0x023627C8 = cmplwi r12, 999

0x0236309C = li r0, 999 ; when some items in stock
0x023630BC = li r0, 999 ; when no item in stock
