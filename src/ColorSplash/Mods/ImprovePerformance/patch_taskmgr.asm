[ColorSplash_Performance]
moduleMatches = 0xCA6B9A52, 0x7467D6CF ; (EU), (NA/JP)
.origin = codecave
...
[ColorSplash_Performance_EU]
moduleMatches = 0xCA6B9A52 ; (EU)
...
[ColorSplash_Performance_NA]
moduleMatches = 0x7467D6CF ; (NA/JP)
